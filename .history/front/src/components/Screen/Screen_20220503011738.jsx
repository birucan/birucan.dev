...
export default function Screen() {
    const [activeWindows, setActiveWindows] = useState([{id:0, window:<IntroWindow key={0}/>, zIndex:1, currentTop:false, title:"Intro", initHeight:150, initWidth:200}], 
    [{id:2, window:<IntroWindow key={2}/>, zIndex:2, currentTop:true, title:"Intro2", initHeight:150, initWidth:200}]);
    ...
    const addWindow=(newWindow, title="untitled", initHeight=200, initWidth=200)=>{
        ...
        setActiveWindows(...activeWindows, {id:windowNum, window:newWindow, zIndex:windowNum, currentTop:true, title:title, initHeight:initHeight, initWidth:initWidth});
