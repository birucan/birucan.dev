...
export default function Screen() {
    const [activeWindows, setActiveWindows] = useState([{id:0, window:<IntroWindow key={0}/>, zIndex:1, currentTop:false, title:"Intro", initHeight:150, initWidth:200}], [{id:2, window:<IntroWindow key={2}/>, zIndex:2, currentTop:true, title:"Intro2", initHeight:150, initWidth:200}]);
