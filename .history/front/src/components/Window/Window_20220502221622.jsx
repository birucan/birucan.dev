...
export default function Window({content=null,
    ...
    return (
      ...
      style={{ width: widthState, height: heightState, padding:'2px' }} className="window" >
        <div key={widthState}  >
        <div className="title-bar" onMouseLeave={setCanDrag(true)} onMouseOver={setCanDrag(true)} onMouseUp={()=>{setCanDrag(false)}}>
