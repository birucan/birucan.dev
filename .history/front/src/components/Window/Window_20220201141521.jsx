...
export default Window = ({content=null,
    ...
    return (
        ...
        <div key={widthState}draggable="false" >
        ...
        <div className="window-body"style={{cursor: pointerState, width: widthState, height: heightState, padding:'2px' }} className="window" onMouseOver={handleHover} onMouseDown={mouseDown} onMouseUp={mouseUp} onMouseMove={mouseMove}>
          {content}
          {mousePosition}
