...
export default Window = ({content=null, title="", maximized=false, hidden=false, width=100, height=100}) => {
    ...
    return (
        ...
        <div draggable="false" style={{ width: widthState, height: heightState, padding:'2px' }} className="window" onMouseOver={handleHover} onMouseDown={mouseDown} onMouseUp={mouseUp}>
