...
export default Window = ({content=null, title="", maximized=false, hidden=false, width=100, height=100}) => {
    ...
    return (
        ...
        <div draggable="true" style={{ width: widthState, height: heightState, padding:'2px',     WebkitUserDrag: "none",
        KhtmlUserDrag: "none",
        MozUserDrag: "none",
        OUserDrag: "none",
        userDrag: "none" }} className="window" onMouseOver={handleHover} onDrag={handleDrag}>
